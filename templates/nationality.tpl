<select class="mb-3" name="nationality" required>
                    ...
                    <option value="British V.I.">British V.I.</option>
                    ...
                    <option value="Georgia del Sur y las islas Sandwich del Sur">Georgia del Sur y las islas Sandwich
                        del Sur</option>
                    ...
                    <option value="Íslas Vírgenes (EE.UU.)">Íslas Vírgenes (EE.UU.)</option>
                    ...
                    <option value="Territorios británicos del océano Índico">Territorios británicos del océano Índico
                    </option>
